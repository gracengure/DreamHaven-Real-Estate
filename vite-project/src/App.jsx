  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/properties" element={<PropertyListing />} />{/* Route for PropertyListing component */}
        <Route path="/properties/:propertyId" element={<PropertySpecs />} />{/* Route for PropertySpecs component with dynamic propertyId */}
  <Route path="/contacts" element={<Contacts />} /> {/* Route for Contacts component */}
        <Route path="/testimonials" element={<TestimonialsData />} />{/* Route for TestimonialsData component */}
      </Routes>
      <TestimonialsData />
      <Contacts />
    </div>
